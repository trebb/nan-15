...
static keypair_t chrdmap[256] EEMEM = {
    ...
    [CHRD(0, 0, 1, 2)] = KEYPAIR(No, Y,              Sh, Y             ),
    [CHRD(0, 0, 1, 3)] = KEYPAIR(No, FN4,            No, NO            ),
    [CHRD(0, 0, 2, 0)] = KEYPAIR(No, G,              Sh, G             ),
    [CHRD(0, 0, 2, 1)] = KEYPAIR(No, Z,              Sh, Z             ),
    [CHRD(0, 0, 2, 2)] = KEYPAIR(No, H,              Sh, H             ),
    ...
    [CHRD(0, 1, 0, 2)] = KEYPAIR(No, UNDO,           No, NO            ),
    [CHRD(0, 1, 0, 3)] = KEYPAIR(No, LOCKING_NUM,    No, NO            ),
    [CHRD(0, 1, 1, 0)] = KEYPAIR(No, 6,              No, F6            ),
    [CHRD(0, 1, 1, 1)] = KEYPAIR(No, 7,              No, F7            ),
    [CHRD(0, 1, 1, 2)] = KEYPAIR(No, LANG4,          No, NO            ),
    [CHRD(0, 1, 1, 3)] = KEYPAIR(No, PAUSE,          No, NO            ),
    [CHRD(0, 1, 2, 0)] = KEYPAIR(No, W,              Sh, W             ),
    [CHRD(0, 1, 2, 1)] = KEYPAIR(No, KP_ENTER,       No, NO            ),
    [CHRD(0, 1, 2, 2)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(0, 1, 2, 3)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(0, 1, 3, 0)] = KEYPAIR(No, FN2,            No, NO            ),
    [CHRD(0, 1, 3, 1)] = KEYPAIR(No, KP_PLUS,        Sh, KP_PLUS       ),
    [CHRD(0, 1, 3, 2)] = KEYPAIR(No, INT7,           No, NO            ),
    [CHRD(0, 1, 3, 3)] = KEYPAIR(No, CRSEL,          No, NO            ),
    [CHRD(0, 2, 0, 0)] = KEYPAIR(No, I,              Sh, I             ),
    [CHRD(0, 2, 0, 1)] = KEYPAIR(No, GRAVE,          Sh, GRAVE         ),
    [CHRD(0, 2, 0, 2)] = KEYPAIR(No, J,              Sh, J             ),
    [CHRD(0, 2, 0, 3)] = KEYPAIR(No, NO ,            No, NO            ),
    [CHRD(0, 2, 1, 0)] = KEYPAIR(No, X,              Sh, X             ),
    [CHRD(0, 2, 1, 1)] = KEYPAIR(No, NO,          Ag|Sh, 8             ),
    [CHRD(0, 2, 1, 2)] = KEYPAIR(No, ESCAPE,         No, NO            ),
    [CHRD(0, 2, 1, 3)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(0, 2, 2, 0)] = KEYPAIR(No, K,              Sh, K             ),
    [CHRD(0, 2, 2, 1)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(0, 2, 2, 2)] = KEYPAIR(No, L,              Sh, L             ),
    [CHRD(0, 2, 2, 3)] = KEYPAIR(No, LEFT,           No, RIGHT         ),
    [CHRD(0, 2, 3, 0)] = KEYPAIR(No, F16,            No, NO            ),
    ...
    [CHRD(1, 0, 0, 3)] = KEYPAIR(Ag, DOT,            Ag, COMMA         ),
    [CHRD(1, 0, 1, 0)] = KEYPAIR(No, A,              Sh, A             ),
    [CHRD(1, 0, 1, 1)] = KEYPAIR(No, B,              Sh, B             ),
    [CHRD(1, 0, 1, 2)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(1, 0, 1, 3)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(1, 0, 2, 0)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(1, 0, 2, 1)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(1, 0, 2, 2)] = KEYPAIR(No, NO,             No, NO            ),
    ...
    [CHRD(1, 1, 0, 1)] = KEYPAIR(No, D,              Sh, D             ),
    [CHRD(1, 1, 0, 2)] = KEYPAIR(No, KP_ASTERISK,    No, NO            ),
    [CHRD(1, 1, 0, 3)] = KEYPAIR(No, KP_MINUS,       No, NO            ),
    [CHRD(1, 1, 1, 0)] = KEYPAIR(No, E,              Sh, E             ),
    [CHRD(1, 1, 1, 1)] = KEYPAIR(No, F,              Sh, F             ),
    [CHRD(1, 1, 1, 2)] = KEYPAIR(No, KP_1,           No, NO            ),
    [CHRD(1, 1, 1, 3)] = KEYPAIR(Ag, E,           Ag|Sh, E             ),
    [CHRD(1, 1, 2, 0)] = KEYPAIR(No, KP_3,           No, NO            ),
    [CHRD(1, 1, 2, 1)] = KEYPAIR(No, KP_4,           No, NO            ),
    [CHRD(1, 1, 2, 2)] = KEYPAIR(No, KP_5,           No, NO            ),
    [CHRD(1, 1, 2, 3)] = KEYPAIR(No, KP_6,           No, NO            ),
    [CHRD(1, 1, 3, 0)] = KEYPAIR(No, KP_7,           No, NO            ),
    [CHRD(1, 1, 3, 1)] = KEYPAIR(Ag, D,           Ag|Sh, D             ),
    [CHRD(1, 1, 3, 2)] = KEYPAIR(No, KP_9,           No, NO            ),
    [CHRD(1, 1, 3, 3)] = KEYPAIR(Ag, C,           Ag|Sh, C             ),
    [CHRD(1, 2, 0, 0)] = KEYPAIR(No, U,              Sh, U             ),
    [CHRD(1, 2, 0, 1)] = KEYPAIR(Ag, NONUS_HASH,  Ag|Sh, NONUS_HASH    ),
    [CHRD(1, 2, 0, 2)] = KEYPAIR(No, APPLICATION,    No, NO            ),
    [CHRD(1, 2, 0, 3)] = KEYPAIR(No, POWER,          No, NO            ),
    [CHRD(1, 2, 1, 0)] = KEYPAIR(No, QUOTE,          Sh, QUOTE         ),
    [CHRD(1, 2, 1, 1)] = KEYPAIR(No, F13,            No, NO            ),
    [CHRD(1, 2, 1, 2)] = KEYPAIR(No, F14,            No, NO            ),
    [CHRD(1, 2, 1, 3)] = KEYPAIR(No, F15,            No, NO            ),
    [CHRD(1, 2, 2, 0)] = KEYPAIR(No, LBRACKET,       Sh, LBRACKET      ),
    [CHRD(1, 2, 2, 1)] = KEYPAIR(No, F17,            No, NO            ),
    [CHRD(1, 2, 2, 2)] = KEYPAIR(No, F18,            No, NO            ),
    [CHRD(1, 2, 2, 3)] = KEYPAIR(Ag, K,           Ag|Sh, K             ),
    [CHRD(1, 2, 3, 0)] = KEYPAIR(No, F20,            No, NO            ),
    [CHRD(1, 2, 3, 1)] = KEYPAIR(No, F21,            No, NO            ),
    [CHRD(1, 2, 3, 2)] = KEYPAIR(No, F22,            No, NO            ),
    [CHRD(1, 2, 3, 3)] = KEYPAIR(Ag, U,           Ag|Sh, U             ),
    [CHRD(1, 3, 0, 0)] = KEYPAIR(No, FN0,            No, NO            ),
    [CHRD(1, 3, 0, 1)] = KEYPAIR(No, EXECUTE,        No, NO            ),
    [CHRD(1, 3, 0, 2)] = KEYPAIR(No, HELP,           No, NO            ),
    [CHRD(1, 3, 0, 3)] = KEYPAIR(No, MENU,           No, NO            ),
    [CHRD(1, 3, 1, 0)] = KEYPAIR(No, SELECT,         No, NO            ),
    [CHRD(1, 3, 1, 1)] = KEYPAIR(Ag, B,           Ag|Sh, B             ),
    [CHRD(1, 3, 1, 2)] = KEYPAIR(No, AGAIN,          No, NO            ),
    [CHRD(1, 3, 1, 3)] = KEYPAIR(Ag, A,           Ag|Sh, A             ),
    [CHRD(1, 3, 2, 0)] = KEYPAIR(No, CUT,            No, NO            ),
    [CHRD(1, 3, 2, 1)] = KEYPAIR(No, COPY,           No, NO            ),
    [CHRD(1, 3, 2, 2)] = KEYPAIR(No, PASTE,          No, NO            ),
    [CHRD(1, 3, 2, 3)] = KEYPAIR(No, FIND,           No, NO            ),
    [CHRD(1, 3, 3, 0)] = KEYPAIR(No, _MUTE,          No, NO            ),
    [CHRD(1, 3, 3, 1)] = KEYPAIR(No, _VOLUP,         No, NO            ),
    [CHRD(1, 3, 3, 2)] = KEYPAIR(No, _VOLDOWN,       No, NO            ),
    [CHRD(1, 3, 3, 3)] = KEYPAIR(No, LOCKING_CAPS,   No, NO            ),
    [CHRD(2, 0, 0, 0)] = KEYPAIR(No, M,              Sh, M             ),
    [CHRD(2, 0, 0, 1)] = KEYPAIR(No, LOCKING_SCROLL, No, NO            ),
    [CHRD(2, 0, 0, 2)] = KEYPAIR(No, N,              Sh, N             ),
    [CHRD(2, 0, 0, 3)] = KEYPAIR(No, KP_EQUAL_AS400, No, NO            ),
    [CHRD(2, 0, 1, 0)] = KEYPAIR(No, SCOLON,         Sh, SCOLON        ),
    [CHRD(2, 0, 1, 1)] = KEYPAIR(No, INT2,           No, NO            ),
    [CHRD(2, 0, 1, 2)] = KEYPAIR(No, INT3,           No, NO            ),
    [CHRD(2, 0, 1, 3)] = KEYPAIR(No, INT4,           No, NO            ),
    [CHRD(2, 0, 2, 0)] = KEYPAIR(No, O,              Sh, O             ),
    [CHRD(2, 0, 2, 1)] = KEYPAIR(No, INT6,           No, NO            ),
    [CHRD(2, 0, 2, 2)] = KEYPAIR(No, P,              Sh, P             ),
    [CHRD(2, 0, 2, 3)] = KEYPAIR(No, INT8,           No, NO            ),
    [CHRD(2, 0, 3, 0)] = KEYPAIR(No, INT9,           No, NO            ),
    [CHRD(2, 0, 3, 1)] = KEYPAIR(No, LANG1,          No, NO            ),
    [CHRD(2, 0, 3, 2)] = KEYPAIR(No, LANG2,          No, NO            ),
    [CHRD(2, 0, 3, 3)] = KEYPAIR(No, LANG3,          No, NO            ),
    [CHRD(2, 1, 0, 0)] = KEYPAIR(No, V,              Sh, V             ),
    [CHRD(2, 1, 0, 1)] = KEYPAIR(No, LANG5,          No, NO            ),
    [CHRD(2, 1, 0, 2)] = KEYPAIR(No, LANG6,          No, NO            ),
    [CHRD(2, 1, 0, 3)] = KEYPAIR(No, LANG7,          No, NO            ),
    [CHRD(2, 1, 1, 0)] = KEYPAIR(No, LANG8,          No, NO            ),
    [CHRD(2, 1, 1, 1)] = KEYPAIR(No, LANG9,          No, NO            ),
    [CHRD(2, 1, 1, 2)] = KEYPAIR(No, ALT_ERASE,      No, NO            ),
    [CHRD(2, 1, 1, 3)] = KEYPAIR(No, SYSREQ,         No, NO            ),
    [CHRD(2, 1, 2, 0)] = KEYPAIR(No, MINUS,          No, NO            ),
    [CHRD(2, 1, 2, 1)] = KEYPAIR(No, CLEAR,          No, NO            ),
    [CHRD(2, 1, 2, 2)] = KEYPAIR(No, PRIOR,          No, NO            ),
    [CHRD(2, 1, 2, 3)] = KEYPAIR(No, RETURN,         No, NO            ),
    [CHRD(2, 1, 3, 0)] = KEYPAIR(No, SEPARATOR,      No, NO            ),
    [CHRD(2, 1, 3, 1)] = KEYPAIR(No, OUT,            No, NO            ),
    [CHRD(2, 1, 3, 2)] = KEYPAIR(No, OPER,           No, NO            ),
    [CHRD(2, 1, 3, 3)] = KEYPAIR(Ag, V,           Ag|Sh, V             ),
    [CHRD(2, 2, 0, 0)] = KEYPAIR(No, Q,              Sh, Q             ),
    [CHRD(2, 2, 0, 1)] = KEYPAIR(No, EXSEL,          No, NO            ),
    [CHRD(2, 2, 0, 2)] = KEYPAIR(No, R,              Sh, R             ),
    [CHRD(2, 2, 0, 3)] = KEYPAIR(No, STOP,           No, NO            ),
    [CHRD(2, 2, 1, 0)] = KEYPAIR(No, KP_0,           No, NO            ),
    [CHRD(2, 2, 1, 1)] = KEYPAIR(No, KP_8,           No, NO            ),
    [CHRD(2, 2, 1, 2)] = KEYPAIR(No, KP_2,           No, NO            ),
    [CHRD(2, 2, 1, 3)] = KEYPAIR(Ag, F,           Ag|Sh, F             ),
    [CHRD(2, 2, 2, 0)] = KEYPAIR(No, S,              Sh, S             ),
    [CHRD(2, 2, 2, 1)] = KEYPAIR(No, KP_SLASH,       No, NO            ),
    [CHRD(2, 2, 2, 2)] = KEYPAIR(No, T,              Sh, T             ),
    [CHRD(2, 2, 2, 3)] = KEYPAIR(Ag, S,           Ag|Sh, S             ),
    [CHRD(2, 2, 3, 0)] = KEYPAIR(No, F19,            No, NO            ),
    ...
    [CHRD(2, 3, 0, 3)] = KEYPAIR(Ag, 4,           Ag|Sh, 4             ),
    [CHRD(2, 3, 1, 0)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(2, 3, 1, 1)] = KEYPAIR(Ag, T,           Ag|Sh, T             ),
    [CHRD(2, 3, 1, 2)] = KEYPAIR(No, F23,            No, NO            ),
    [CHRD(2, 3, 1, 3)] = KEYPAIR(No, CLEAR_AGAIN,    No, NO            ),
    [CHRD(2, 3, 2, 0)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(2, 3, 2, 1)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(2, 3, 2, 2)] = KEYPAIR(Ag, P,           Ag|Sh, P             ),
    ...
    [CHRD(3, 0, 1, 0)] = KEYPAIR(No, FN7,         Ag|Sh, 9             ),
    [CHRD(3, 0, 1, 1)] = KEYPAIR(Sh, KP_COMMA,    Ag|Sh, 0             ),
    [CHRD(3, 0, 1, 2)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 0, 1, 3)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 0, 2, 0)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 0, 2, 1)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 0, 2, 2)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 0, 2, 3)] = KEYPAIR(No, NO,          Ag|Sh, MINUS         ),
    [CHRD(3, 0, 3, 0)] = KEYPAIR(No, TAB,            Sh, TAB           ),
    [CHRD(3, 0, 3, 1)] = KEYPAIR(Ag, LBRACKET,    Ag|Sh, LBRACKET      ),
    [CHRD(3, 0, 3, 2)] = KEYPAIR(No, NO,          Ag|Sh, RBRACKET      ),
    ...
    [CHRD(3, 1, 1, 0)] = KEYPAIR(No, NO,          Ag|Sh, COMMA         ),
    [CHRD(3, 1, 1, 1)] = KEYPAIR(No, PSCREEN,     Ag|Sh, DOT           ),
    [CHRD(3, 1, 1, 2)] = KEYPAIR(Ag, SLASH,       Ag|Sh, SLASH         ),
    [CHRD(3, 1, 1, 3)] = KEYPAIR(No, NO,          Ag|Sh, NONUS_BSLASH  ),
    [CHRD(3, 1, 2, 0)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 1, 2, 1)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 1, 2, 2)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 1, 2, 3)] = KEYPAIR(Ag, W,           Ag|Sh, W             ),
    ...
    [CHRD(3, 2, 1, 3)] = KEYPAIR(Ag, X,           Ag|Sh, X             ),
    ...
    [CHRD(3, 3, 1, 2)] = KEYPAIR(Ag, Y,           Ag|Sh, Y             ),
    [CHRD(3, 3, 1, 3)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(3, 3, 2, 0)] = KEYPAIR(No, F24,            No, NO            ),
    [CHRD(3, 3, 2, 1)] = KEYPAIR(Ag, Z,           Ag|Sh, Z             ),
    [CHRD(3, 3, 2, 2)] = KEYPAIR(Ag, H,           Ag|Sh, H             ),
    [CHRD(3, 3, 2, 3)] = KEYPAIR(Ag, G,           Ag|Sh, G             ),
    [CHRD(3, 3, 3, 0)] = KEYPAIR(Ag, NONUS_BSLASH,   Ag, RBRACKET      ),
    [CHRD(3, 3, 3, 1)] = KEYPAIR(No, NO,             No, INSERT        ),
    [CHRD(3, 3, 3, 2)] = KEYPAIR(No, NO,          Ag|Sh, BSLASH        ),
