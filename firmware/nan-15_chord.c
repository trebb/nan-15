...
static keypair_t chrdmap[256] EEMEM = {
    ...
    [CHRD(2, 0, 0, 1)] = KEYPAIR(No, NO,             No, NO            ),
    [CHRD(2, 0, 0, 2)] = KEYPAIR(No, N,              Sh, N             ),
    [CHRD(2, 0, 0, 3)] = KEYPAIR(No, NO,             No, NO            ),
    ...
    [CHRD(2, 2, 0, 1)] = KEYPAIR(No, NO,             No, NO            ),
